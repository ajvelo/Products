...
class ProductsAppUITests: XCTestCase {
    ...
    func testUITableViewLoaded() {
        let app = XCUIApplication()
        let tablesQuery = app.tables
        let cellQuery = tablesQuery.cells.containing(.staticText, identifier: "ProductsTableViewCell")
